(function () {
  ...
  const STEERING_COMMITTEE = [
    ...
    { id:"sc4", key:"Orit_Shachar", nameEn:"Orit Shahar", nameJa:"オリット・シャハル", nameHe:"אורית שחר", org:"JDC‑Eshel", orgHe:"ג'וינט ישראל – אשל", role:"Area Head Health and functioning for older adult", roleHe:"ראש תחום בריאות ותפקוד למבוגרים", email:"Orits@jdc.org", photo:"Orit_Shachar.jpg" },
  ];
